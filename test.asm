...
.DATA                           ;declare data segment
    ...
    MAINMENU_O2 DB  "                            2. REGISTER", '$'
    MAINMENU_O3 DB  "                            3. EXIT", '$'
    ...
    ;register section
    REGISTER_MESSAGE    DB  "HERE IS REGISTER",'$'
...
.CODE                                           ;declare code segment
    ...
    MAINMENU:
        ...
        MOV AH,09H                              ;prepare to display
        LEA DX,MAINMENU_O3                      ;load the address of the string
        INT 21H                                 ;proceed to display
        ...
        CMP SPACE_MAINMENU[0],"2"                                ;if user input is 2, go to register module
        JE  REGISTER_MENU

        CMP SPACE_MAINMENU[0],"3"                                ;if user input is 2, exit program
        JE  EXIT
    ...
    REGISTER_MENU:
        ...
        MOV AH,09H
        LEA DX,REGISTER_MESSAGE                  ;display register page message
        INT 21H
